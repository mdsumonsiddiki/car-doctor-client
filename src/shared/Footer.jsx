...
const Footer = () => {
    return (
        <footer className="bg-dark-1 dark:bg-gray-900 text-dark-6 pt-10">
            ...
            <div className="lg:flex">
                <div className="w-full -mx-6 lg:w-2/5">
                    <div className="px-6">
                        ...
                        <p className="max-w-sm mt-2 text-dark-6 dark:text-gray-400">JEdwin Diaz is a software and web technologies engineer, a life coach trainer who is also a serial .</p>
                ...
                <div className="mt-6 lg:mt-0 lg:flex-1">
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3">
                        <div>
                            <h3 className="text-gray-700 uppercase pb-3 dark:text-white">About</h3>
                        ...
                        <div>
                            <h3 className="text-gray-700 uppercase pb-3 dark:text-white">Blog</h3>
                        ...
                        <div>
                            <h3 className="text-gray-700 uppercase pb-3 dark:text-white">Products</h3>
